...
const linkMap: Record<string, { href: string; isDominant?: boolean }> = {
  'Change Your Name in North Carolina': { href: '/resources/charlotte#name-change' },
  'Find Food Pantries & Free Food in Charlotte': { href: '/resources/charlotte#food' },
  'Open the Complete Charlotte Resource Guide': {
    href: '/resources/charlotte#complete-directory',
    isDominant: true,
  },
  'Visit Charlotte Trans Health': { href: 'https://charlottetranshealth.org/' },
  'Find Food in Charlotte': { href: '/resources/charlotte#food' },
  'Check Nourish Up Locations': { href: 'https://www.nourishup.org/' },
  'Open the Charlotte Food Pantry Guide': { href: '/resources/charlotte#food' },
  ...
  'Open the NC Name Change Guide': { href: '/resources/charlotte#name-change' },
  'Explore Crisis Assistance Ministry': { href: 'https://www.crisisassistance.org/' },
  'See Clothing & Mutual Aid Resources': { href: '/resources/charlotte#clothing' },
  'See Reproductive Health Resources': { href: '/resources/charlotte#reproductive-health' },
  'See Disability & Accessibility Resources': { href: '/resources/charlotte#disability-accessibility' },
  'Find Queer Community in Charlotte': { href: '/resources/charlotte#queer-community' },
  'Browse Queer-Friendly Charlotte Businesses': {
    href: '/resources/charlotte#friendly-businesses',
  },
  'Browse the Full Resource Directory': { href: '/resources/charlotte#complete-directory' },
  'See Books & Educational Resources': { href: '/resources/charlotte#books-guides' },
  ...
  'Open the Charlotte Food Guide': { href: '/resources/charlotte#food' },
  'Open the Complete Local Resource Guide': { href: '/resources/charlotte#complete-directory' },
  'NC Name Change Guide': { href: '/resources/charlotte#name-change' },
  'Go to the NC Name Change Guide': { href: '/resources/charlotte#name-change' },
  'Charlotte Food Pantry Guide': { href: '/resources/charlotte#food' },
  'Complete Charlotte / NC Resource Guide': { href: '/resources/charlotte#complete-directory' },
}
